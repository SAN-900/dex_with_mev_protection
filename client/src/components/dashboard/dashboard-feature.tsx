  ...
  return (
    <div className="w-full">
        ...
        <p
          ...
          "
        >
          Aroha DEX analyzes swap conditions before execution and helps
          protect users from unsafe routes, excessive slippage, and risky
          transaction behavior on Solana.
        </p>
